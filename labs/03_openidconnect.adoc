...
As already mentioned in a previous lap Keycloak offers (as specified link:https://openid.net/specs/openid-connect-discovery-1_0.html[here]) an `.well-known` endpoint at http://keycloak:8180/auth/realms/techlab/.well-known/openid-configuration.
